...
pass_ = playerdashptpass.PlayerDashPtPass(last_n_games=82, player_id=steph, team_id=gsw)
print(pass_.passes_made.get_dict())
print("\n\n\n\n\n")
print(pass_.passes_received.get_dict())
